...
C
      SUBROUTINE GEO_GRAD3D(XB,YB,ZB,RHO_UP,RHO_LOW,XP,YP,ZP,GEO)
C     =====================
C
C***********************************************************************
C
C Subroutine calculates the geoid effects of a rectangular
C prism with its sides parallel to the coordinate system and a density
C that may present a vertical linear gradient. Formula derived by
C Hermann Zeyen.
C
C***********************************************************************
C
